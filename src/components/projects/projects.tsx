  ...
  return (
    <>
      ...
      <div className="projectGrid">
        <ProjectCard title="Obsidian LLM RAG" subtitle="Python local RAG System" img={obsidianLogo} links={[{name: "GitHub", url: "https://github.com/AliceCamposDev/obsidian-rag"}]} desc="Python LLM assistant that answer questions based in the context of a given Obsidian Vault" />
        <ProjectCard title="My portfolio" subtitle="React website" img={kuromi} links={[{name: "GitHub", url: "https://github.com/AliceCamposDev/alice-portfolio"},{name: "Live demo", url:"https://alice-portfolio-five.vercel.app/"}]} desc="simple front-end to show my projects I'M NOT A DESIGNER, SORRY" />
        <ProjectCard title="Guerrilha Urbana" subtitle="Angular website" img={d20} links={[{name: "GitHub", url: "https://github.com/AliceCamposDev/rpg-guerrilha-urbana"},{name: "Live demo", url:"https://alicecamposdev.github.io/rpg-guerrilha-urbana/"}]} desc="Angular website for my TTRPG system, help players navigate trough game material and automate character sheet creation"/>
